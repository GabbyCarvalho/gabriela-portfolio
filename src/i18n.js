export const t = {
  ...
  resume: {
      ...
      pt: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Construí o front-end utilizando React, JavaScript (ES6+), HTML5 e CSS3.",
            "Integrei serviços de terceiros (HoneyBook, Pic-Time) em uma aplicação React.",
            "Apliquei arquitetura baseada em componentes e otimizei UX, performance e acessibilidade.",
          ],
        },
      ],
    },
    ...
    educationData: {
      en: [
        { degree: "Associate Degree in Systems Analysis and Development", institution: "Faculdade Metropolitanas Unidas (FMU)", period: "Aug 2023 – Dec 2025" },
        { degree: "Fullstack JavaScript Program", institution: "OneBitCode", period: null },
        { degree: "Essential HTML & CSS – Complete Front-End Course", institution: "Udemy", period: null },
      ],
      pt: [
        { degree: "Tecnólogo em Análise e Desenvolvimento de Sistemas", institution: "Faculdade Metropolitanas Unidas (FMU)", period: "Ago 2023 – Dez 2025" },
        { degree: "Programa Fullstack JavaScript", institution: "OneBitCode", period: null },
        { degree: "HTML & CSS Essencial – Curso Completo de Front-End", institution: "Udemy", period: null },
      ],
    },
  },
  ...
  projects: {
    ...
    sub:     { en: "A collection of work built with curiosity and care.", pt: "Uma coleção de projetos construídos com curiosidade e cuidado." },
    visit:   { en: "Visit website", pt: "Visitar site" },

    data: {
      en: [
        {
          id: 1,
          name: "Pedro & Naidhig Law Firm - Institutional Website",
          stack: ["React", "JavaScript", "CSS"],
          link: "https://pedroenaidhig.vercel.app/",
          description: "An institutional website developed for a full-service law firm, designed to showcase its legal expertise, services, and professional presence online. Built with React, the project focuses on responsive design, technical SEO, performance optimization, and a clear, user-friendly experience that makes it easy for potential clients to explore the firm's services and get in touch.",
        ...
        {
          id: 3, name: "KBPhotographer", stack: ["React", "JavaScript", "CSS"],
          link: "https://kbphotographer.com/",
        ...
        {
          id: 4,
          name: "KBPhotographer - Social Links",
          stack: ["React", "JavaScript", "CSS"],
          links: [
        ...
        {
          id: 5, name: "Front-End Developer Website", stack: ["React", "JavaScript","CSS"],
          link: "https://www.gcstudio.dev/",
          description: "A modern, responsive portfolio website developed with React and JavaScript. The project focuses on reusable components, responsive design, performance optimization, user experience, and SEO best practices.",
          features: ["Responsive layout", "Elegante Style", "User-centered design"],
        },
        {
          id: 6, name: "Real Estate Landing Page", stack: ["React", "JavaScript","CSS"],
          link: "https://corretora-lp.vercel.app/",
        ...
        {
          id: 7, name: "Restaurant Website", stack: ["HTML", "CSS"],
        ...
        {
          id: 8, name: "Travel Agency Website", stack: ["HTML", "CSS", "Bootstrap"],
        ...
        {
          id: 9, name: "Seals Informative Website", stack: ["HTML", "CSS"],
        ...
        {
          id: 10, name: "Calculator", stack: ["HTML", "CSS", "JavaScript"],
        ...
        {
          id: 11, name: "Game Library", stack: ["React", "JavaScript", "CSS"],
        ...
        {
          id: 12, name: "Tic-Tac-Toe", stack: ["HTML", "CSS", "JavaScript"],
        ...
        {
          id: 13, name: "Rock, Paper, Scissors", stack: ["React", "JavaScript", "CSS"],
      ...
      pt: [
        {
          id: 1,
          name: "Pedro & Naidhig - Advogados - Website Institucional",
          stack: ["React", "JavaScript", "CSS"],
          link: "https://pedroenaidhig.vercel.app/",
          description: "Site institucional desenvolvido para um escritório de advocacia, com o objetivo de apresentar sua atuação, serviços jurídicos e presença profissional no ambiente digital. Desenvolvido em React, o projeto combina design responsivo, SEO técnico, otimização de performance e uma experiência de usuário clara e intuitiva, facilitando o acesso às informações e o contato com potenciais clientes.",
        ...
        {
          id: 3, name: "KBPhotograph", stack: ["React", "JavaScript", "CSS"],
          link: "https://kbphotographer.com/",
        ...
        },
        {
          id: 5, name: "Front-End Developer Website", stack: ["React","JavaScript", "CSS"],
          link: "https://www.gcstudio.dev/",
          description: "Site profissional para apresentação de serviços de desenvolvimento Front-End, projetos e soluções digitais para clientes. Desenvolvido com React e JavaScript, com foco em design responsivo, performance, experiência do usuário e boas práticas de SEO.",
          features: ["Layout responsivo", "Hierarquia visual e espaçamento", "Estilo clássico e luxuoso", "Design centrado no usuário"],
        },
        {
          id: 6, name: "Corretora de Imóveis", stack: ["React","JavaScript", "CSS"],
          link: "https://corretora-lp.vercel.app/",
        ...
        {
          id: 7, name: "Website de Restaurante", stack: ["HTML", "CSS"],
          link: "https://gabbycarvalho.github.io/pizza-place/",
        ...
        {
          id: 8, name: "Website de Agência de Viagens", stack: ["HTML", "CSS", "Bootstrap"],
          link: "https://gabbycarvalho.github.io/travel-agency/",
        ...
        {
          id: 9, name: "Website Informativo sobre Focas", stack: ["HTML", "CSS"],
          link: "https://gabbycarvalho.github.io/seals/",
        ...
        {
          id: 10, name: "Calculadora", stack: ["HTML", "CSS", "JavaScript"],
          link: "https://gabbycarvalho.github.io/calculator/",
        ...
        {
          id: 11, name: "Biblioteca de Jogos", stack: ["React", "JavaScript", "CSS"],
          link: "https://gabbycarvalho.github.io/game-library/",
        ...
        {
          id: 12, name: "Jogo da Velha", stack: ["HTML", "CSS", "JavaScript"],
          link: "https://gabbycarvalho.github.io/tic-tac-toe/",
        ...
        {
          id: 13, name: "Pedra, Papel, Tesoura", stack: ["React", "JavaScript", "CSS"],
          link: "https://gabbycarvalho.github.io/rock-paper-scissors/",
  ...
  // ── Contact ──────────────────────────────────────────────
  contact: {
    pre:       { en: "> contact.init()", pt: "> contato.init()" },
    title:     { en: "Let's work", pt: "Vamos trabalhar" },
    titleSpan: { en: "together.", pt: "juntos." },
    sub:       { en: "I'd love to connect and learn how I can bring value to your team or project. Looking forward to hearing from you!", pt: "Adoraria me conectar e entender como posso agregar valor ao seu time ou projeto. Fico no aguardo do seu contato!" },
    getInTouch:{ en: "Get in touch", pt: "Entre em contato" },
    infoText:  { en: "Whether you have a project in mind, a question, or just want to say hi — my inbox is always open. I'll do my best to get back to you as soon as possible.", pt: "Seja para falar sobre um projeto, tirar uma dúvida ou apenas dizer olá — minha caixa de entrada está sempre aberta. Farei o possível para responder o quanto antes." },
    sendMsg:   { en: "Send a message", pt: "Enviar mensagem" },
    name:      { en: "Name", pt: "Nome" },
    namePh:    { en: "Your name", pt: "Seu nome" },
    email:     { en: "Email", pt: "E-mail" },
    emailPh:   { en: "your@email.com", pt: "seu@email.com" },
    message:   { en: "Message", pt: "Mensagem" },
    messagePh: { en: "Tell me about your project...", pt: "Fale sobre seu projeto..." },
    send:      { en: "Send message", pt: "Enviar mensagem" },
    location:  { en: "São Paulo, Brazil · Open to Remote", pt: "São Paulo, Brasil · Aberta a Remoto" },
  },
};